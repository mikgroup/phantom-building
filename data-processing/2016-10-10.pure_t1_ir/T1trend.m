...
%%
slices = [1];
idx1 = [3, 9, 13, 18, 2, 8, 14, 19, 1, 7, 15, 21, ...
     4, 10, 16, 5, 11, ... % Add 5 back in
    17, 23, 6, 12, 22];
...
targetT1 = [830, 500, 1230, 1000, 250, 500, 830, 500, 1230, 1000, 250, 500];
targetT2 = [80, 110, 110, 120, 60, 70, 80, 110, 110, 120, 60, 70];
concA = [0.1766, 2.1795, 0.0037, 0.4676, 4.6338, 1.3486, ...
    0.2976, 1.8608, 0.0885, 14.3624, 2.203, 7.6232];
concB = [0.1019, 0.0435, 0.0633, 0.0502, 0.1104, 0.1122, ...
    0.1736, 0.0832, 0.0072, 0.013, 0.0124, 0.0559];

order = [5, 2, 2, 6, 6, 1, 1, 4, 3, 3 ...
    11, 11, 8, 8, 12, 12, 7, 7, 10, 10, 9, 9];
