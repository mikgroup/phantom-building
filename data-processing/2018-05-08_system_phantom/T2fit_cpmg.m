function T2fit_cpmg(echoes, filename)
% JT 07-2016
T2imgs_raw = sqreadcfl('cpmg-fft');
T2imgs_raw = permute(T2imgs_raw, [1, 2, 5, 3, 4]); % only map specific slices
%T2imgs_raw = T2imgs_raw(:,:,:,:,2:6);
%echoes = 2:2:32;
T2imgs_raw = T2imgs_raw(150:350,20:110,:,:,echoes);
...
echo_times = (10:10:320) * 1e-3; %
echo_times = echo_times(echoes);
