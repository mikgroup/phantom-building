...
clear;
close all;
T1imgs_raw = sqreadcfl('ir_cimg_long_tr');
T1imgs_raw = permute(T1imgs_raw, [1, 2, 5, 3, 4]);
T1imgs_raw = T1imgs_raw(:,:,:,:,[2, 4, 5, 6, 8]);
...
inv_times = [50, 100, 300, 500, 900, 1300, 1700, 2000, 5000] * 1e-3; % 2016-08-01_phantom-test
inv_times = inv_times([2, 4, 5, 6, 8]);
%%
...
save T1fit_long_tr_partial.mat