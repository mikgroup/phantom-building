...
% nicl_conc = [4     0     2     3     1     1     2     0     0     2     1     0     1     3     0];
% mncl_conc = [0     3     1     1     1     3     2     2     0     0     0     4     2     0     1];
% 
% t1_vals = t1_vals(nicl_conc ~= 0 & mncl_conc ~= 0);
% t2_vals = t2_vals(nicl_conc ~= 0 & mncl_conc ~= 0);
