...
load T2fit_mc_first_8.mat
load('/Users/karthikgopalan/Downloads/EMC_results.mat')

maps = zpad(EMC_results.T2map_SEMC, 512, 152);
T2est = imresize(maps, [512 76]);

T2est = repmat(T2est, 1,1,1,4);
...
nicl_sol_volume = [0.4,0.8,1.2,0.4,0.8,1.2,0.4,0.8,1.2,0.4,0.8,1.2,0.4,0.8,1.2,0.4,0.8,1.2,0.4,0.8,1.2,0.4,0.8,1.2,0.4,0.8,1.2];
mncl_sol_volume = [0.2,0.2,0.2,0.4,0.4,0.4,0.6,0.6,0.6,0.2,0.2,0.2,0.4,0.4,0.4,0.6,0.6,0.6,0.2,0.2,0.2,0.4,0.4,0.4,0.6,0.6,0.6];
