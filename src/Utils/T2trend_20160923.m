load ~/Documents/Projects/Phantom/phantom-building/data-processing/2016-09-23/T2fit.mat
rng(10);
...
slices = [1];
idx1 = [4, 8, 12, 3, 7, 11, 2, 6, 10, 1, 5, 9];
idxs = {idx1};
